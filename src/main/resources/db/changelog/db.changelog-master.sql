...
-- =========================================
-- 002: Create usuarios table (without FK to perfil_usuario)
-- =========================================
...
--changeset christian:007.4
ALTER TABLE public.perfil_usuario
    ADD CONSTRAINT FK_perfil_usuario_usuario
    FOREIGN KEY (id_usuario) REFERENCES public.usuarios(id_usuario) ON DELETE CASCADE;


-- =========================================
-- 008: Now add FK from usuarios → perfil_usuario
-- =========================================
--changeset christian:008
ALTER TABLE public.usuarios
    ADD CONSTRAINT FK_user_perfil
    FOREIGN KEY (id_perfil) REFERENCES public.perfil_usuario(id_perfil) ON DELETE SET NULL;


-- =========================================
-- 009: Create trackpoint table
-- =========================================
...
-- =========================================
-- 010: Create trackpoint_extension table
-- =========================================
...
-- =========================================
-- 011: Add all remaining FK constraints
-- =========================================

--changeset christian:011.1
ALTER TABLE public.entrenamiento
    ADD CONSTRAINT FK_entreno_usuario
    FOREIGN KEY (id_usuario) REFERENCES public.usuarios(id_usuario) ON DELETE CASCADE;

--changeset christian:011.2
ALTER TABLE public.lap
    ADD CONSTRAINT FK_lap_entreno
    FOREIGN KEY (id_entrenamiento) REFERENCES public.entrenamiento(id_entrenamiento) ON DELETE CASCADE;

--changeset christian:011.3
ALTER TABLE public.lap_extension
    ADD CONSTRAINT FK_lapext_lap
    FOREIGN KEY (id_lap) REFERENCES public.lap(id_lap) ON DELETE CASCADE;

--changeset christian:011.4
ALTER TABLE public.notificacion
    ADD CONSTRAINT FK_notif_usuario
    FOREIGN KEY (id_usuario) REFERENCES public.usuarios(id_usuario) ON DELETE CASCADE;

--changeset christian:011.5
ALTER TABLE public.trackpoint
    ADD CONSTRAINT FK_tp_lap
    FOREIGN KEY (id_lap) REFERENCES public.lap(id_lap) ON DELETE CASCADE;

--changeset christian:011.6
ALTER TABLE public.trackpoint_extension
    ADD CONSTRAINT FK_tpe_tp
    FOREIGN KEY (id_trackpoint) REFERENCES public.trackpoint(id_trackpoint) ON DELETE CASCADE;
